//GPGMP: You should replace this file's contents with whatever your build of GMP's config.h has...and hope doing that doesn't break GPGMP because I don't have 10 years of unit and community testing to find out if GPGMP works on all systems :D
...
/* The gmp-mparam.h file (a string) the tune program should suggest updating.
   */
#define GMP_MPARAM_H_SUGGEST "./../src/v6.3.0-27b6a2315b.clean/mpn/x86_64/k8/gmp-mparam.h"
...
//#define HAVE_NATIVE_mpn_add_nc 1 //GPGMP
//#define HAVE_NATIVE_mpn_addaddmul_1msb0 1 //GPGMP
//#define HAVE_NATIVE_mpn_addlsh1_n 1 //GPGMP
//#define HAVE_NATIVE_mpn_addlsh2_n 1 //GPGMP
//#define HAVE_NATIVE_mpn_addlsh_n 1 //GPGMP
...
//#define HAVE_NATIVE_mpn_addmul_2 1 //GPGMP
...
/* #undef HAVE_NATIVE_mpn_addmul_2s */
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_and_n 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_andn_n 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_bdiv_dbm1c 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_bdiv_q_1 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_pi1_bdiv_q_1 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_cnd_add_n 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_cnd_sub_n 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_com 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_copyd 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_copyi 1
/* #undef HAVE_NATIVE_mpn_div_qr_1n_pi1 */
/* #undef HAVE_NATIVE_mpn_div_qr_2 */
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_divexact_1 1
/* #undef HAVE_NATIVE_mpn_divexact_by3c */
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_divrem_1 1
/* #undef HAVE_NATIVE_mpn_divrem_1c */
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_divrem_2 1
/* #undef HAVE_NATIVE_mpn_gcd_1 */
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_gcd_11 1
/* #undef HAVE_NATIVE_mpn_gcd_22 */
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_hamdist 1
//#define HAVE_NATIVE_mpn_invert_limb 1 //GPGMP
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_ior_n 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_iorn_n 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_lshift 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_lshiftc 1
/* #undef HAVE_NATIVE_mpn_lshsub_n */
/* #undef HAVE_NATIVE_mpn_mod_1 */
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_mod_1_1p 1
/* #undef HAVE_NATIVE_mpn_mod_1c */
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_mod_1s_2p 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_mod_1s_4p 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_mod_34lsub1 1
//#define HAVE_NATIVE_mpn_modexact_1_odd 1 //GPGMP
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_modexact_1c_odd 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_mul_1 1
//#define HAVE_NATIVE_mpn_mul_1c 1 //GPGMP
//#define HAVE_NATIVE_mpn_mul_2 1 //GPGMP
/* #undef HAVE_NATIVE_mpn_mul_3 */
/* #undef HAVE_NATIVE_mpn_mul_4 */
/* #undef HAVE_NATIVE_mpn_mul_5 */
/* #undef HAVE_NATIVE_mpn_mul_6 */
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_mul_basecase 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_mullo_basecase 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_nand_n 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_nior_n 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_popcount 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_preinv_divrem_1 1
/* #undef HAVE_NATIVE_mpn_preinv_mod_1 */
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_redc_1 1
/* #undef HAVE_NATIVE_mpn_redc_2 */
//#define HAVE_NATIVE_mpn_rsblsh1_n 1 //GPGMP
//#define HAVE_NATIVE_mpn_rsblsh2_n 1 //GPGMP
...
/* #undef HAVE_NATIVE_mpn_rsblsh_nc */
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_rsh1add_n 1
//#define HAVE_NATIVE_mpn_rsh1add_nc 1 //GPGMP
//#define HAVE_NATIVE_mpn_rsh1sub_n 1 //GPGMP
//#define HAVE_NATIVE_mpn_rsh1sub_nc 1 //GPGMP
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_rshift 1
/* #undef HAVE_NATIVE_mpn_sbpi1_bdiv_r */
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_sqr_basecase 1
/* #undef HAVE_NATIVE_mpn_sqr_diagonal */
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_sqr_diag_addlsh1 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_sub_n 1
//#define HAVE_NATIVE_mpn_sub_nc 1 //GPGMP
//#define HAVE_NATIVE_mpn_sublsh1_n 1 //GPGMP
...
/* #undef HAVE_NATIVE_mpn_umul_ppmm_r */
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_xor_n 1
 //!TOTAL GPGMP WIPEOUT #define HAVE_NATIVE_mpn_xnor_n 1
