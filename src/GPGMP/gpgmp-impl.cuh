...
#define MP_PTR_SWAP_DATA(ptr1, ptr2, numLimbsSwap)                          \
    do                                                \
    {                                                 \
        for (mp_size_t __mp_ptr_swap__i = 0; __mp_ptr_swap__i < (numLimbsSwap); ++__mp_ptr_swap__i) \
        {                                             \
            mp_limb_t __mp_ptr_swap__tmp = (ptr1)[__mp_ptr_swap__i]; \
            (ptr1)[__mp_ptr_swap__i] = (ptr2)[__mp_ptr_swap__i];        \
            (ptr2)[__mp_ptr_swap__i] = __mp_ptr_swap__tmp;           \
        }                                             \
    } while (0)
