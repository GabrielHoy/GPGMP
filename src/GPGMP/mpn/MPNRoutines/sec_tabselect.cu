...
#define SEC_TABSELECT_METHOD 1
    ...
    ANYCALLER void gpmpn_sec_tabselect(volatile mp_limb_t *rp, volatile const mp_limb_t *tab, mp_size_t n, mp_size_t nents, mp_size_t which)
    {
      mp_size_t k, i;
      mp_limb_t mask;
    ...
    ANYCALLER void gpmpn_sec_tabselect(volatile mp_limb_t *restrict rp, volatile const mp_limb_t *restrict tab, mp_size_t n, mp_size_t nents, mp_size_t which)
    {
      mp_size_t k, i;
