...
/* Computes Q = N / D mod B^n,
    ...
    ANYCALLER mp_limb_t mpn_bdiv_qr (mp_ptr qp, mp_ptr rp, mp_srcptr np, mp_size_t nn, mp_srcptr dp, mp_size_t dn, mp_ptr tp)
    {
      mp_limb_t di;
      mp_limb_t rh;
    ...
    ANYCALLER mp_size_t mpn_bdiv_qr_itch (mp_size_t nn, mp_size_t dn)
    {
