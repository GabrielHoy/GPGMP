...
namespace gpgmp {
  namespace mpnRoutines {
   ...
   gpmpn_jacobi_update */
    ...
    ANYCALLER static void hgcd_jacobi_hook (void *p, mp_srcptr gp, mp_size_t gn, mp_srcptr qp, mp_size_t qn, int d)
    {
      ASSERT (!gp);
      ASSERT (d >= 0);
    ...
    */
    ...
    ANYCALLER static mp_size_t hgcd_jacobi_step (mp_size_t n, mp_ptr ap, mp_ptr bp, mp_size_t s, struct hgcd_matrix *M, unsigned *bitsp, mp_ptr tp)
    {
