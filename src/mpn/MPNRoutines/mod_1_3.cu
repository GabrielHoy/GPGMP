...
namespace gpgmp
{
  namespace mpnRoutines
  {
    ...
    ANYCALLER void gpmpn_mod_1s_3p_cps(mp_limb_t cps[6], mp_limb_t b)
    {
      mp_limb_t bi;
    ...
    ANYCALLER mp_limb_t gpmpn_mod_1s_3p(mp_srcptr ap, mp_size_t n, mp_limb_t b, const mp_limb_t cps[6])
    {
